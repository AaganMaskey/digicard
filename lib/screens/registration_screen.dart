          ...
          children: <Widget>[
            ...
            Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: <Widget>[
                 FadeAnimation( 1,Text('Registration',style: TextStyle(color: shadowColor, fontSize: 40,fontFamily:'Karla2' ),)),
            ...
            Expanded(
              child: Container(
                ...
                child: Padding(
                  ...
                  SizedBox(height: 20,),
                FadeAnimation (1.7,Text("Already have account?", style: TextStyle(color: textColor),),),
                  SizedBox(height: 10,),
